...
public class OtherProfileReviewRecyclerViewAdapter extends RecyclerView.Adapter<OtherProfileReviewRecyclerViewAdapter.ViewHolder> {
    ...
    public OtherProfileReviewRecyclerViewAdapter(ArrayList<Review> reviews) {
