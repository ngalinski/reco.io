...
public class SearchRecyclerViewAdapter extends RecyclerView.Adapter<SearchRecyclerViewAdapter.ViewHolder> {
    ...
    private SearchRecyclerViewAdapter.ItemClickListener itemClickListener;
    private StorageReference storageReference = FirebaseStorage.getInstance().getReference();
    private final DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
    private final DatabaseReference usersReference = databaseReference.child("users");
    private String currentUserName;

    public SearchRecyclerViewAdapter(ArrayList<Review> reviews, String currentUserName) {
        this.reviews = reviews;
        this.currentUserName = currentUserName;
    }

    public void setItemClickListener(SearchRecyclerViewAdapter.ItemClickListener listener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SearchRecyclerViewAdapter.ViewHolder holder, final int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull final View itemView, final SearchRecyclerViewAdapter.ItemClickListener listener) {
            super(itemView);
